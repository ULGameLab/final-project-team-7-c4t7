...
public class StateMachineBlackStormTrooper : MonoBehaviour
{
    //NavMesh
    ...
    void executeP()
    {
        ...
        if (Mathf.Abs((transform.position - pTarget.transform.position).magnitude) < 2)
        {
            Debug.Log("Hit");
            if (pTarget == pTarget1) { pTarget = pTarget2; }
